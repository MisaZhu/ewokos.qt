...
/* EwokOS: the monolithic <QtCore> include pulls in qstdlibdetection.h, which
   errors out on the EwokOS libcxx (none of the known STL macros are defined).
   Include just what this header actually uses instead. */
#include <QByteArray>
