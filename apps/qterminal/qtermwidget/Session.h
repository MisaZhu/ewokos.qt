...
// EwokOS: no QProcess (Qt is built -no-feature-process); the Pty
// re-implementation carries the ExitStatus enum Session needs.
#include "Pty.h"
...
private slots:
    void done(int, Konsole::Pty::ExitStatus );
