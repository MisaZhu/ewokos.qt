...
{
public:
  /* EwokOS: the tree builds with -fno-rtti, so the dynamic_casts the
     HistoryType::scroll() implementations used to sort scrolls by concrete
     type are replaced with this manual discriminator. */
  enum Kind { KindNone, KindFile, KindBuffer, KindBlockArray, KindCompact };
...
public:
  ...
  Kind kind() const override { return KindFile; }
...
public:
  ...
  Kind kind() const override { return KindBuffer; }
...
public:
  ...
  Kind kind() const override { return KindNone; }
...
public:
  ...
  Kind kind() const override { return KindBlockArray; }
...
public:
  ...
  Kind kind() const override { return KindCompact; }
