...
/* EwokOS: no fontconfig either, so "Monospace" resolves to nothing and the
   widget would start with the proportional theme font.  Name a real monospace
   TTF from /usr/system/fonts; matches DEFAULT_FONT in the app's config.h. */
